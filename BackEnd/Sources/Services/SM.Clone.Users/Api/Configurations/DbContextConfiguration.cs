using Infrastructures.EF.Contexts;
...
namespace Api.Configurations
{
    public static class DbContextConfiguration
    {
        ...
        public static void SetUserDbContext(
            ...
            ConfigurationManager configuration)
        {
            ...
            collection.AddDbContext<UserDbContext>(options => options.UseSqlServer(connectionString));
        }
    }
}